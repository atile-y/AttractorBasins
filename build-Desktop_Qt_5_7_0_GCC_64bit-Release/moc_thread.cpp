...
QT_MOC_LITERAL(4, 25, 10) // "stateError"

    },
    "Thread\0stateReady\0\0State\0stateError"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Thread::*_t)(State );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::stateReady)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::stateError)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Thread::stateReady(State _t1)
{
